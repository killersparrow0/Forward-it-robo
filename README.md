...
### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/killersparrow0/Forward-it-robo)
...
Deploy in your vps
```sh
git clone https://github.com/killersparrow0/Forward-it-robo
cd Frwit
